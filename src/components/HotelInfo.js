...
const HotelInfo = () => {
	...
	const loadAccessibilityData = async() => {
		...
		const resp = await fetch('https://g11az0gxvi.execute-api.us-east-1.amazonaws.com/Production/Accessibilities');
	...
	const loadServiceData = async() => {
		...
		// Query the API Gateway
		const resp = await fetch('https://g11az0gxvi.execute-api.us-east-1.amazonaws.com/Production/services');
		let jsonData = await resp.json();
